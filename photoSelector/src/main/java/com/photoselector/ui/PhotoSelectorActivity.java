...
public class PhotoSelectorActivity extends Activity implements onItemClickListener, onPhotoItemCheckedListener,
	...
	public static PhotoSelectorActivity act;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context  = this;
		photoAdapter = new PhotoSelectorAdapter(getApplicationContext(), pms,
				CommonUtils.getWidthPixels(context), PhotoSelectorActivity.this, PhotoSelectorActivity.this, PhotoSelectorActivity.this);
