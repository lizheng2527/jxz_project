package com.zdhx.androidbase.view.imagecycleview;
...
public class ImageCycleView extends LinearLayout {
	 ...
	 */
	public void setImageResources(final ArrayList<ADInfo> infoList, ImageCycleViewListener imageCycleViewListener) {
		// 清除所有子视图
...
//					if (!NetUtils.isNetFileAvailable(infoList.get(i).getUrl())) {
//						infoList.remove(i);
//					}
//				}
//			}
