...
public class IosAlertDialog {
	...
	public IosAlertDialog setTitle(int title) {
		showTitle = true;
		if (title == 0) {
			txt_title.setText("标题");
		} else {
	...
	public IosAlertDialog setMsg(int resId) {
		showMsg = true;
		if (resId == 0) {
			txt_msg.setText("内容");
		} else {
			txt_msg.setText(resId);
		}
		return this;
	}
	...
	public IosAlertDialog setIsShowMsg(boolean isShow) {
		this.showMsg = isShow;
		return this;
	}

	public IosAlertDialog setIsShowEditText(boolean isShow) {
		this.showEditText = isShow;
		return this;
	}
