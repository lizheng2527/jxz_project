 ...
 */
public class HideWebView extends WebView {
    public static final int SHOW_SUTITLE = 2;
    private Context mContext ;
    private ImageView mLeftButton;
    private WebView mMiddleButton;
     ...
     * @param attrs
     */
    public HideWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView();
    }
    ...
    private void initView() {
        ...
        setBackgroundDrawable(new ColorDrawable(mContext.getResources().getColor(R.color.top_bg)));
        LayoutInflater.from(getContext()).inflate(R.layout.hide_webview, this, true);
        mLeftButton = (ImageView) findViewById(R.id.btn_left);
        mMiddleButton = (WebView) findViewById(R.id.hide_webView);
...
//        super.loadUrl(url);
     ...
     * @param l
     */
    public void setTopBarToStatus(int type, int leftResid, int rightResid, int titleRes, OnClickListener l) {
        String str = "";
        if (titleRes != -1) {
