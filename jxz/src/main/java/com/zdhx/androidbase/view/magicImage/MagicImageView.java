package com.zdhx.androidbase.view.magicImage;
...
import com.zdhx.androidbase.ui.photoview.IPhotoView;
 ...
 *
 */
public class MagicImageView extends ImageView implements IPhotoView {
...
//        options.inJustDecodeBounds = false;
    ...
    private class TouchListener implements OnTouchListener {
        ...
        private void performRotate(MotionEvent event) {
            curP1.set(event.getX(0), event.getY(0));
            Log.e("event.getX(0)",event.getX(0)+"");
            Log.e("event.getY(0)",event.getY(0)+"");
            curP2.set(event.getX(1), event.getY(1));
            Log.e("event.getX(1)",event.getX(1)+"");
            Log.e("event.getY(1)",event.getY(1)+"");
