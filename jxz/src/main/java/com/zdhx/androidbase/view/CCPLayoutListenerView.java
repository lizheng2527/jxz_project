...
public class CCPLayoutListenerView extends FrameLayout {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        LogUtil.d(LogUtil.getLogUtilsTag(getClass()), "容联•云通讯 Modify By Li.Xin @ 立思辰合众chan onInitializeAccessibilityEvent");
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        LogUtil.d(LogUtil.getLogUtilsTag(getClass()), "容联•云通讯 Modify By Li.Xin @ 立思辰合众chan onInitializeAccessibilityNodeInfo");
    }
    ...
    public void onPopulateAccessibilityEvent(AccessibilityEvent event) {
        ...
        LogUtil.d(LogUtil.getLogUtilsTag(getClass()), "容联•云通讯 Modify By Li.Xin @ 立思辰合众chan onPopulateAccessibilityEvent");
    }
