package com.zdhx.androidbase.ui.picturecarousel;
...
public class PicsView extends RelativeLayout {
     ...
     * 同时设置文字描述和图片数据
     */
    public void addTitlesAndImages(String[] titles, List<SimpleDraweeView> images) {
        this.titles = titles;
        this.images = images;
     ...
     * 添加轮播图片
     */
    public void addImages(List<SimpleDraweeView> images) {
        this.images = images;
        if (titles == null || titles.length == 0) {
            mRl.setVisibility(GONE);
        }
