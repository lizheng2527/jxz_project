package com.zdhx.androidbase.ui.treelistview.utils;
...
public class Node {
	...
	public Node(String id, String pId, String name, String contactId,String headPortraitUrl) {
		super();
		this.id = id;
		this.pId = pId;
		this.name = name;
	...
	public Node(String id, String pId, String name, String contactId,
