...
public class ImageCacheManager {
	...
	public static final String CACHE_DIR = "Hzth_IM";
	
	/** 海报文件缓存目录 */
	public static final String DIR_PLACARD ="headImgCache";
	/** 商品列表图片文件缓存目录 */
	public static final String DIR_PRODUCT = "imgCache";
	...
	public ImageCacheManager(Context context) {
		...
		File cacheDir = new File(sdCard, "/Android/data/" + context.getPackageName()
				+ "/cache/");
		mFileCachePlacard = new FileCache(context, cacheDir, DIR_PLACARD);
		mFileCachePlacard = new FileCache(context, cacheDir, DIR_PRODUCT);
	}
