...
package com.zdhx.volley.toolbox;

import android.os.SystemClock;

import com.zdhx.volley.AuthFailureError;
import com.zdhx.volley.Cache;
import com.zdhx.volley.Cache.Entry;
import com.zdhx.volley.Network;
...
import com.zdhx.volley.RetryPolicy;
	...
	public NetworkResponse performRequest(Request<?> request) throws VolleyError {
		...
		while (true) {
			...
			try {
				...
				System.out.println("leimingtech--------------server response:-statusCode:" + statusCode + "-reason:"
